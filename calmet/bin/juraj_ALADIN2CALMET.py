...
path_ala2 = '/data/nwp/ala2e/grib/sh20/'  #'/data/oko/dusan/ala_temp_2023/' 
path_output = '/data/oko/krajc/tmp'

names2d = ['prmsl','cwp','csf','lsf','lswp','sde','ssrd','sshf','2t','2sh','10u','10v','sp','orog','hpbl']
#names2d = ['hpbl', '2t','2sh','10u','10v']
