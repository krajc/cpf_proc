...
prof = 'ave'
ggroup = 'fh'
hdir = f'/users/p2993/calpuff/{dom}/harmo/{prof}/{group}/{ggroup}'
memory = '10GB'
...
slurmdir = f'/work/users/p2993/calpuff/{dom}/harmo/{prof}/{group}/{ggroup}/submit'
if not os.path.exists(slurmdir):
    os.makedirs(slurmdir)
logdir = f'/work/users/p2993/calpuff/{dom}/harmo/{prof}/{group}/{ggroup}/logs'
